  ...
  const CollapsibleRow = ({ conversation }) => {
    ...
    return (
      ...
      >
        ...
        {showFeedback && <TableCell sx={{ verticalAlign: 'middle', width: '120px' }}>
        ...
        {showFeedback && <TableCell sx={{ verticalAlign: 'middle', width: '200px' }}>
        ...
        {showFeedback && <TableCell sx={{ verticalAlign: 'middle', minWidth: '350px' }}>
          ...
          <Box sx={{ mb: 2 }}>
            <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
              ...
              <FormControlLabel
                ...
                label={<Typography variant="body2" fontSize="small" fontWeight="700">Include Feedback</Typography>}
                sx={{ ml: 2 }}
              />
              <Button
                size="small"
            ...
            <Box sx={{ 
              ...
              <TableHead>
                <TableRow>
                  ...
                  {!showFeedback && <TableCell sx={{ color: 'text.secondary', fontWeight: 600, whiteSpace: 'nowrap', verticalAlign: 'middle' }}>Timeframes</TableCell>}
                  {!showFeedback && <TableCell sx={{ color: 'text.secondary', fontWeight: 600, whiteSpace: 'nowrap', verticalAlign: 'middle' }}>Source</TableCell>}
                  {!showFeedback && <TableCell sx={{ color: 'text.secondary', fontWeight: 600, whiteSpace: 'nowrap', verticalAlign: 'middle' }}>User identifier</TableCell>}
                  ...
                  {showFeedback && <TableCell sx={{ color: 'text.primary', fontWeight: 600, verticalAlign: 'middle', width: '120px', whiteSpace: 'nowrap' }}>Feedback rating</TableCell>}
                  {showFeedback && <TableCell sx={{ color: 'text.primary', fontWeight: 600, verticalAlign: 'middle', width: '200px', whiteSpace: 'nowrap' }}>Feedback category</TableCell>}
                  {showFeedback && <TableCell sx={{ color: 'text.primary', fontWeight: 600, verticalAlign: 'middle', minWidth: '350px', whiteSpace: 'nowrap' }}>Feedback comment</TableCell>}
                </TableRow>
              </TableHead>
              <TableBody>
                {sortedConversations
